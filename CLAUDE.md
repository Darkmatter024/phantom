...
- Live: `v1.14.179` — **Ship B1+B2 shipped (router gating 1–2/4); awaiting John device-verify.** Prior: `.174`–`.177` device-verified (all good), R-3b COMPLETE. (History: `.173` landing REJECTED on device → rebuilt as `.175`.)
