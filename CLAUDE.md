...
- Live: `v1.14.180` — **Ship B1+B2+B3 shipped (router gating 1–3/4); B4 HARD-STOPPED for John's device-verify (highest blast radius).** Prior: `.174`–`.177` device-verified, R-3b COMPLETE. (History: `.173` landing REJECTED on device → rebuilt as `.175`.)
