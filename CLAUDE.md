...
- Live: `v1.14.177` — **device-verified `.174`–`.177` by John (2026-07-04), all good. Cork cleared. R-3b COMPLETE.** (History: `.173` landing was REJECTED on device → rebuilt as `.175`.)
